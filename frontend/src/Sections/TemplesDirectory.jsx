  ...
  return (
    <section className="td-container">
      <div className="td p-10 text-center">
        <form>
          <input type="text" className='w-[95vw] rounded-lg mt-2 bg-white' placeholder='Search any temple here from our directory' value={templeText} onChange={handleOnTextChange} autoComplete='false'/>
        </form>
      </div>
    </section>
  )
